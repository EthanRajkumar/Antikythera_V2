...
public class SolarEclipsePredictController extends SceneController {

    @FXML
    TableView<SolarEclipse> eclipseView;

    @FXML
    Label predictionTime, predictionVisibility, predictionHeader, predictionHeader2;

    List<SolarEclipse> eclipses;
    ...
    {
        SolarEclipse eclipse = eclipseView.getSelectionModel().getSelectedItem();

        EclipseFinder ef = new EclipseFinder();
        SolarEclipse nearest = ef.PredictReoccuringSolar(eclipse);
    ...
    {
        EclipseFinder ef = new EclipseFinder();
        SolarEclipse nearest = ef.PredictNextSolarEclipse(eclipses);
        UniversalTime time = nearest.time;
