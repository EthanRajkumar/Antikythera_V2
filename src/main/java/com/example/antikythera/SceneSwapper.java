...
public class SceneSwapper {
    ...
    public static SceneController GetController(String sceneUrl, FXMLLoader loader)
    {
        switch (sceneUrl)
        {
            ...
            case "lunar_eclipse_prediction.fxml":
            {
                return loader.<LunarEclipsePredictController>getController();
            }

            case "solar_eclipse_prediction.fxml":
            {
                return loader.<SolarEclipsePredictController>getController();
            }
