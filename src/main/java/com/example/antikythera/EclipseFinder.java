...
public class EclipseFinder {
    ...
    public SolarEclipse PredictReoccuringSolar(SolarEclipse eclipse)
    {
        ZonedDateTime newTime = eclipse.time.ToZonedDate(ZoneId.of("GMT"));
        UniversalTime newUT = new UniversalTime(newTime);
        SolarEclipse newEclipse = new SolarEclipse(newUT, eclipse.saros, eclipse.magnitude, eclipse.centralDuration, eclipse.getType(), eclipse.getVisibility());

        newEclipse.time.addSeconds((int)(SarosCycle * SecondsInDay));

        return newEclipse;
    }

    public LunarEclipse PredictReoccuringLunar(LunarEclipse eclipse)
    {
        ZonedDateTime newTime = eclipse.time.ToZonedDate(ZoneId.of("GMT"));
        UniversalTime newUT = new UniversalTime(newTime);
        LunarEclipse newEclipse = new LunarEclipse(newUT, eclipse.saros, eclipse.magnitude, eclipse.centralDuration, eclipse.getType(), eclipse.getVisibility());
    ...
    public SolarEclipse PredictNextSolarEclipse(List<SolarEclipse> eclipses)
    {
        eclipses = eclipses.size() == 0 ? GetSolarEclipses() : eclipses;

        SolarEclipse farthestEclipse = null, newEclipse = null;
        ...
        return PredictReoccuringSolar(farthestEclipse);
    }

    public LunarEclipse PredictNextLunarEclipse(List<LunarEclipse> eclipses)
    {
        eclipses = eclipses.size() == 0 ? GetLunarEclipses() : eclipses;

        LunarEclipse farthestEclipse = null, newEclipse = null;
        ...
        return PredictReoccuringLunar(farthestEclipse);
    }
